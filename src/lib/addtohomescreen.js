...
ath.intl = {
	...
	fa_ir: {
		ios: 'برای اضافه کردن لینوکسی ها به خانه، %icon را لمس کنید و بعد گزینه <strong>Add to Home Screen</strong> را انتخاب کنید.',
		android: 'برای اضافه کردن لینوکسی ها به خانه، %icon را لمس کنید و بعد گزینه <strong>Add to Home Screen</strong> را انتخاب کنید.'
	},
